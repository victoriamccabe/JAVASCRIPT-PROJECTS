...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed, we convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand if it doesn't exist.
    ...
    keys.addEventListener('click', (event) => {
        ...
        //This one checks if the key is a number and then calls the Input_Digit function
