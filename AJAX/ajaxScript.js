function getMsg() {
    ...
    //Get input value of name to display to user agter request has been made
    ...
    //STEP 3: Defines the AJAX response callback method that establishes whether the response was successful and where the data shoud be displayed
